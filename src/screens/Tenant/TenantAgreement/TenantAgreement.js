...
// import { GetOneTenantAgreementDetail } from "../../../Redux/Reducer/GetOneTenantAgreement";
import {GetOneTenantAgreement} from "../../../Redux/Reducer/GetOneTenantAgreement";
...
export default function TenantAgreements() {
  ...
  const getId=window.location.pathname.replace("/tenant-agreement/", "")
  
  const dispatch = useDispatch();

  useEffect(() => {
    dispatch(GetOneTenantAgreement({ id: getId })).then((res) => {
